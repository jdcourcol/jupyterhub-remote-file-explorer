...
export function activate(context: vscode.ExtensionContext) {
	console.log('JupyterHub Remote File Explorer is now active');
	...
	vscode.workspace.getConfiguration().update('jupyterhub.rememberCredentials', true, vscode.ConfigurationTarget.Global);
	
	// Try to connect automatically if credentials are saved
	vscode.commands.executeCommand('jupyterhub-remote-file-explorer.connect');
}
